...
c          SumD2 = dipole_type_1_gg_g(1,p1,p2,p3,p4) 
c     .          +dipole_type_1_gg_g(2,p1,p2,p3,p4)
c        if (answer .ge. 100d0 ) then !print*,answer,SumD
c        if (sig .ge. 100d0 ) print*,sig,SumD
...
c	print*,"boost:",iboost
c	print*,"sigma :",sig
c	print*,"1real_amp :",answer
c	print*,"SumDipole :",SumD
c	print*,"SumDipol2 :",SumD2/2d0
c	print*,"s12   :",s12
c	print*,"s14   :",s14
c	print*,"s24   :",s24
