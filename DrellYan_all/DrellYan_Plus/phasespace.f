...
c     invariant mass of diphoton pair.
      s34    = am3**2d0 + am4**2d0 + 2*dot(p3,p4)
      xxinvmass= dsqrt(s34)
...
c      SUBROUTINE GEN_PHASE_SPACE( X1,X2,X4, AM3,AM4, RS, P1,P2,P3,P4 )
      subroutine kinvar2_type_2(x1,x2,x4,xxinvmass,p1,p2,p3,p4)
  
      DOUBLE PRECISION X1, X2, X4, AM3, AM4, RS
...
c      am3 = 125.0d0
      ...
      E4 = 0.5D0 * (SP + AM4**2 - AM3**2) / RSP
      XLAM = (AM4**2 - (RSP + AM3)**2) * (AM4**2 - (RSP - AM3)**2)
      PCM = 0.5D0 * DSQRT(XLAM)
...
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++      
      ...
      subroutine kinvar3_mod(xx,xxjac,xinvmass,p1,p2,p3,p4,p5,unphy)
      implicit double precision (a-h,o-z)
      integer n4,unphy
