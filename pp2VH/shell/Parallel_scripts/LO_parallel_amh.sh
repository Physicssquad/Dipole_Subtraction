...
#    sed -i "s/am3=[^ ]*/am3=${step_size}d0/" LO_gg2H/main.f
...
tmp_dir=$(mktemp -d)
tmp_dir2=$(mktemp -d)
cp run.machine.dat output_files.dat param_card.dat LO_gg2H/main.f $tmp_dir
cp run.machine.dat output_files.dat param_card.dat LO_gg2H/main.f $tmp_dir2
